...
VALUES("Medicina", 2800.00, "4 semestres", "30%" ,1);

INSERT INTO tb_produtos (curso, preco, duracao, desconto, id_categoria) 
VALUES("Turismo", 650.00, "6 semestres","20%", 2);
...
INSERT INTO tb_produtos (curso, preco, duracao, desconto, id_categoria) 
VALUES("Analise e Desenvolvimento de Sistemas", 1100.00, "2 anos","45%",4);

INSERT INTO tb_produtos (curso, preco, duracao, desconto, id_categoria)
 VALUES("TI", 999.99, "6 meses","10%", 3);
